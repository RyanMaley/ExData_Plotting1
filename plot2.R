...
plot2 <- function (){
        ##
        ## Produces a Global Active Power by Day Plot
        ##        
        ZipArchive <- tempfile()
        ...
        ## Generate the line chart for Plot 2
        plot(TheData$Time,as.numeric(TheData$Global_active_power),type="l",ylab="Global Active Power (kilowatts)")
